...
import imgImage from "figma:asset/6480a52b4ccf55f226f31501e403af0ce0530229.png";
import imgImage5 from "figma:asset/3c8413f5b8f065f5e119be497bd42be5d5fa1dfe.png";
import imgImage6 from "figma:asset/ec9ece07e59d387940a98bfe1f094d83aab63bc3.png";
...
function Text() {
  return (
    <div className="content-stretch flex flex-col gap-[48px] items-center relative shrink-0 w-full" data-name="Text">
      <div className="flex flex-col font-['Pretendard:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[44px] text-center text-white tracking-[-1.1px] w-full">
...
function Text1() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start leading-[0] not-italic relative shrink-0 w-full" data-name="Text">
      <div className="flex flex-col font-['Pretendard:Bold',sans-serif] justify-center relative shrink-0 text-[28px] text-black tracking-[-0.56px] w-full">
